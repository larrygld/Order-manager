...
public class OrderServiceImplTest {
    ...
    private final String ORDER_ID = "1564370304137572846";

    @Test
    public void create() throws Exception {

        OrderDTO orderDTO = new OrderDTO();
        orderDTO.setBuyerName("测试111");
        orderDTO.setBuyerAddress("欣苑食堂");
        ...
        o1.setProductId("8888888");
        o1.setProductQuantity(2);

        OrderDetail o2 = new OrderDetail();
        o2.setProductId("7777777");
